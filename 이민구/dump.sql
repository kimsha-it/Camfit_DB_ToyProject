...
LOCK
TABLES `camping_log` WRITE;
/*!40000 ALTER TABLE `camping_log` DISABLE KEYS */;
INSERT INTO `camping_log`
VALUES (1, 1, 1, '가족과 함께 즐거운 시간이었습니다.', '2025-10-30 01:10:13'),
       (2, 2, 2, '조용하고 좋았어요.', '2025-10-30 01:10:13');
...
LOCK
TABLES `campsite` WRITE;
/*!40000 ALTER TABLE `campsite` DISABLE KEYS */;
INSERT INTO `campsite`
VALUES (1, '서울대공원 캠핑장', '서울대공원에 위치한 캠핑장입니다.', NULL, NULL, NULL, '2025-10-30 10:09:50', '2025-10-30 10:26:10', 2),
       (2, '가평 자라섬 캠핑장', '자라섬에 위치한 캠핑장입니다.', NULL, NULL, NULL, '2025-10-30 10:09:50', '2025-10-30 10:09:50', 2);
...
LOCK
TABLES `campsite_category` WRITE;
/*!40000 ALTER TABLE `campsite_category` DISABLE KEYS */;
INSERT INTO `campsite_category`
VALUES (1, 1, 1),
       (2, 2, 2);
...
LOCK
TABLES `campsite_detail` WRITE;
/*!40000 ALTER TABLE `campsite_detail` DISABLE KEYS */;
INSERT INTO `campsite_detail`
VALUES (1, 'A-1', '데크', 1),
       (2, 'B-2', '파쇄석', 2);
...
LOCK
TABLES `campsite_detail_category` WRITE;
/*!40000 ALTER TABLE `campsite_detail_category` DISABLE KEYS */;
INSERT INTO `campsite_detail_category`
VALUES (1, '편의시설'),
       (2, '자연환경');
...
LOCK
TABLES `campsite_stock` WRITE;
/*!40000 ALTER TABLE `campsite_stock` DISABLE KEYS */;
INSERT INTO `campsite_stock`
VALUES (1, 1, 10, 2, 8, '2025-10-30 10:10:04', '2025-10-30 10:10:04'),
       (2, 2, 20, 5, 15, '2025-10-30 10:10:04', '2025-10-30 10:10:04');
...
VALUES (1, 1, 2, '멋진 사진이네요!', '2025-10-30 02:10:22', '2025-10-30 02:10:22'),
       (2, 2, 1, '제주도 정말 가보고 싶어요 :야자수:', '2025-10-30 02:10:22', '2025-10-30 02:10:22'),
       (3, 3, 4, '등산 코스가 어디인가요? 뷰가 멋져요!', '2025-10-30 02:10:22', '2025-10-30 02:10:22'),
       (4, 4, 6, '고양이 너무 귀엽네요 :발:', '2025-10-30 02:10:22', '2025-10-30 02:10:22'),
       (5, 5, 3, '노트북 모델이 어떤 건가요?', '2025-10-30 02:10:22', '2025-10-30 02:10:22'),
       (6, 6, 5, '저도 그 책 읽고 감동받았어요 :책:', '2025-10-30 02:10:22', '2025-10-30 02:10:22'),
       (7, 7, 8, '완주 축하드려요! 대단하세요 :근육:', '2025-10-30 02:10:22', '2025-10-30 02:10:22'),
       (8, 8, 9, '저 커피숍 분위기 좋아 보이네요 :커피:', '2025-10-30 02:10:22', '2025-10-30 02:10:22'),
       (9, 9, 10, '비 오는 날엔 확실히 여유롭죠 :미소짓는_상기된_얼굴:', '2025-10-30 02:10:22', '2025-10-30 02:10:22'),
       (10, 10, 7, '프로젝트 발표 수고 많으셨어요!', '2025-10-30 02:10:22', '2025-10-30 02:10:22');
...
VALUES (1, 1, 37.0000000, 127.0000000, '경기도 과천시 대공원광장로 102'),
       (2, 2, 38.0000000, 128.0000000, '경기도 가평군 가평읍 자라섬로 60');
...
INSERT INTO `media`
VALUES (1, 'posts', 1, 'IMAGE', '/uploads/posts/1_jeju_beach.jpg', 1, '2025-10-30 02:10:22', '2025-10-30 02:10:22'),
       (2, 'posts', 1, 'IMAGE', '/uploads/posts/1_sunset.jpg', 2, '2025-10-30 02:10:22', '2025-10-30 02:10:22'),
       (3, 'posts', 2, 'VIDEO', '/uploads/posts/2_cafe_vlog.mp4', 1, '2025-10-30 02:10:22', '2025-10-30 02:10:22'),
       (4, 'posts', 3, 'IMAGE', '/uploads/posts/3_hiking.jpg', 1, '2025-10-30 02:10:22', '2025-10-30 02:10:22'),
       (5, 'posts', 4, 'IMAGE', '/uploads/posts/4_food_trip.jpg', 1, '2025-10-30 02:10:22', '2025-10-30 02:10:22'),
       (6, 'product', 1, 'IMAGE', '/uploads/products/1_main.jpg', 1, '2025-10-30 02:10:22', '2025-10-30 02:10:22'),
       (7, 'product', 1, 'IMAGE', '/uploads/products/1_detail_1.jpg', 2, '2025-10-30 02:10:22', '2025-10-30 02:10:22'),
       (8, 'product', 2, 'IMAGE', '/uploads/products/2_main.jpg', 1, '2025-10-30 02:10:22', '2025-10-30 02:10:22'),
       (9, 'product', 3, 'VIDEO', '/uploads/products/3_review.mp4', 1, '2025-10-30 02:10:22', '2025-10-30 02:10:22'),
       (10, 'product', 4, 'IMAGE', '/uploads/products/4_thumbnail.jpg', 1, '2025-10-30 02:10:22',
        '2025-10-30 02:10:22'),
       (11, 'camping_log', 1, 'IMAGE', '/uploads/camping/1_tent_setup.jpg', 1, '2025-10-30 02:10:22',
        '2025-10-30 02:10:22'),
       (12, 'camping_log', 1, 'IMAGE', '/uploads/camping/1_campfire.jpg', 2, '2025-10-30 02:10:22',
        '2025-10-30 02:10:22'),
       (13, 'camping_log', 2, 'VIDEO', '/uploads/camping/2_morning_scenery.mp4', 1, '2025-10-30 02:10:22',
        '2025-10-30 02:10:22'),
       (14, 'camping_log', 3, 'IMAGE', '/uploads/camping/3_mountain_view.jpg', 1, '2025-10-30 02:10:22',
        '2025-10-30 02:10:22'),
       (15, 'camping_log', 4, 'IMAGE', '/uploads/camping/4_river_side.jpg', 1, '2025-10-30 02:10:22',
        '2025-10-30 02:10:22');
...
INSERT INTO `payment`
VALUES (1, '2025-10-30 01:09:46', 'credit_card', 50000),
       (2, '2025-10-30 01:09:46', 'bank_transfer', 75000);
...
INSERT INTO `posts`
VALUES (1, 1, '제주도 여행 중 찍은 사진입니다! :야자수:', '2025-10-30 02:10:22', '2025-10-30 02:10:22'),
       (2, 2, '오늘 점심으로 먹은 파스타가 정말 맛있었어요 :스파게티:', '2025-10-30 02:10:22', '2025-10-30 02:10:22'),
       (3, 3, '새로 산 노트북 개봉기 :컴퓨터::반짝임:', '2025-10-30 02:10:22', '2025-10-30 02:10:22'),
       (4, 4, '주말에 친구들과 등산 다녀왔어요 :산:', '2025-10-30 02:10:22', '2025-10-30 02:10:22'),
       (5, 5, '요즘 읽고 있는 책이 너무 감동적이에요 :책:', '2025-10-30 02:10:22', '2025-10-30 02:10:22'),
       (6, 6, '우리집 고양이 너무 귀엽죠? :고양이:', '2025-10-30 02:10:22', '2025-10-30 02:10:22'),
       (7, 7, '회사에서 프로젝트 발표 끝! 이제 한숨 돌립니다 :숨을_내쉬는_얼굴:', '2025-10-30 02:10:22', '2025-10-30 02:10:22'),
       (8, 8, '첫 마라톤 완주! 다리 아프지만 뿌듯해요 :달리는_남성:', '2025-10-30 02:10:22', '2025-10-30 02:10:22'),
       (9, 9, '새로운 커피숍 발견:커피: 분위기가 정말 좋아요.', '2025-10-30 02:10:22', '2025-10-30 02:10:22'),
       (10, 10, '비 오는 날엔 라디오 들으면서 쉬는 게 최고네요 :비구름:', '2025-10-30 02:10:22', '2025-10-30 02:10:22');
...
LOCK
TABLES `product_detail` WRITE;
/*!40000 ALTER TABLE `product_detail` DISABLE KEYS */;
INSERT INTO `product_detail`
VALUES (1, '무료배송 / 2~3일 소요', '7일 이내 교환 가능', '폴리에스터 원단, 방수 처리', '캠프라인 공식몰'),
...
LOCK
TABLES `product_stock` WRITE;
/*!40000 ALTER TABLE `product_stock` DISABLE KEYS */;
INSERT INTO `product_stock`
VALUES (1, 50, '2025-10-30 02:10:22'),
       (2, 20, '2025-10-30 02:10:22'),
       (3, 80, '2025-10-30 02:10:22'),
       (4, 30, '2025-10-30 02:10:22'),
       (5, 40, '2025-10-30 02:10:22'),
       (6, 25, '2025-10-30 02:10:22'),
       (7, 60, '2025-10-30 02:10:22'),
       (8, 35, '2025-10-30 02:10:22'),
       (9, 15, '2025-10-30 02:10:22'),
       (10, 45, '2025-10-30 02:10:22');
...
(
    ...
    CONSTRAINT `reservation_ibfk_3` FOREIGN KEY (`campsite_detail_id`) REFERENCES `campsite_detail` (`campsite_detail_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
VALUES (1, 1, 1, '2025-10-30 01:10:17', '2025-11-01 05:00:00', '2025-11-02 02:00:00', 'RESERVED'),
       (2, 2, 2, '2025-10-30 01:10:17', '2025-11-08 05:00:00', '2025-11-09 02:00:00', 'RESERVED');
...
INSERT INTO `review`
VALUES (1, 1, 1, '텐트 설치도 쉽고 방수도 잘 됩니다.'),
       (2, 2, 2, '의자 튼튼하고 접을 때 부드러워요.'),
       (3, 3, 3, '랜턴 밝기가 조절되어 너무 좋아요.'),
       (4, 4, 4, '테이블 무게감이 있어서 안정적입니다.'),
       (5, 5, 5, '버너 화력 좋고 가벼워서 만족해요.'),
       (6, 1, 6, '코펠 세트 깔끔하고 가성비 좋아요.'),
       (7, 2, 7, '보온병 하루종일 따뜻하게 유지돼요.'),
       (8, 3, 8, '수납함 크기 적당하고 실용적이에요.'),
       (9, 4, 9, '침낭 따뜻하고 부드러워서 만족합니다.'),
       (10, 5, 10, '해먹 편하고 튼튼해서 추천합니다.');
...
LOCK
TABLES `search_history` WRITE;
/*!40000 ALTER TABLE `search_history` DISABLE KEYS */;
INSERT INTO `search_history`
VALUES (1, 1, '서울 캠핑장', '2025-10-30 01:10:20'),
       (2, 2, '가평 캠핑장', '2025-10-30 01:10:20');
...
LOCK
TABLES `stock_history` WRITE;
/*!40000 ALTER TABLE `stock_history` DISABLE KEYS */;
INSERT INTO `stock_history`
VALUES (1, 1, 50, '초기 입고', '2025-10-30 02:10:22'),
       (2, 2, 20, '초기 입고', '2025-10-30 02:10:22'),
       (3, 3, 80, '초기 입고', '2025-10-30 02:10:22'),
       (4, 4, 30, '초기 입고', '2025-10-30 02:10:22'),
       (5, 5, 40, '초기 입고', '2025-10-30 02:10:22'),
       (6, 6, 25, '초기 입고', '2025-10-30 02:10:22'),
       (7, 7, 60, '초기 입고', '2025-10-30 02:10:22'),
       (8, 8, 35, '초기 입고', '2025-10-30 02:10:22'),
       (9, 9, 15, '초기 입고', '2025-10-30 02:10:22'),
       (10, 10, 45, '초기 입고', '2025-10-30 02:10:22');
...
INSERT INTO `users`
VALUES (1, 'chulsoo', 'chulsoo@example.com', 'chul234!', '01012345678', '2025-10-30 02:10:22'),
       (2, 'minji', 'minji@example.com', 'minji567!', '01023456789', '2025-10-30 02:10:22'),
       (3, 'haneul', 'haneul@example.com', 'sky890!', '01034567890', '2025-10-30 02:10:22'),
       (4, 'jisoo', 'jisoo@example.com', 'jisoo123!', '01045678901', '2025-10-30 02:10:22'),
       (5, 'donghyun', 'donghyun@example.com', 'dong456!', '01056789012', '2025-10-30 02:10:22'),
       (6, 'suhyun', 'suhyun@example.com', 'su789!', '01067890123', '2025-10-30 02:10:22'),
       (7, 'yuna', 'yuna@example.com', 'yuna000!', '01078901234', '2025-10-30 02:10:22'),
       (8, 'taemin', 'taemin@example.com', 'tae321!', '01089012345', '2025-10-30 02:10:22'),
       (9, 'harin', 'harin@example.com', 'hari999!', '01090123456', '2025-10-30 02:10:22'),
       (10, 'jinho', 'jinho@example.com', 'jin555!', '01091234567', '2025-10-30 02:10:22');
